...
export const getFolderData = createAsyncThunk<
  AxiosResponse<FolderDataResponse>
>("dispatch/getFolderData", async () => {
  const response = await spigenAxios.get(`/sop/getAllFolderList`);
  return response;
});
export const createFolder = createAsyncThunk<
  AxiosResponse<FolderDataResponse>,
  { id: string; name: string }
>("dispatch/createFolder", async (payload) => {
  const response = await spigenAxios.post(`/sop/createFolder`, {
    parentFolder: payload.id,
...
export const deleteFolder = createAsyncThunk<
  AxiosResponse<FolderDataResponse>,
  string
>("dispatch/deleteFolder", async (id) => {
  const response = await spigenAxios.delete(`/sop/delete/${id}`);
  return response;
});
export const uploadFileAsync = createAsyncThunk<
  AxiosResponse<{ success: boolean; message: string }>,
  FormData
>("dispatch/uploadFileAsync", async (data) => {
  const response = await spigenAxios.post(`/sop/uploadFile`, data, {
...
export const getFileAsync = createAsyncThunk<
  AxiosResponse<FileDataReponse>,
  string
>("dispatch/getFileAsync", async (id) => {
  const response = await spigenAxios.get(`/sop/getAllFileList/${id}`);
  return response;
});
